...
description: 文献阅读方法论工具包——结构化笔记、文献矩阵、Gap识别、质量评价，帮你把文献"读透"而非"搜到"。 适用于 文献综述、文献挖掘、文献矩阵、PRISMA、文献检索
  等场景。
allowed-tools:
- read
- write
...
1. 与literature-review/literature-reviewer-skill(检犬)互补——它们检索，本技能精读。
...
> 你安装了文献研究。学术全能包旗下共 12 个工具，本机缺了 10 个。
